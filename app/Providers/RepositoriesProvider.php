...
use App\Repositories\Impl\ContractsRepository;
...
use App\Repositories\Impl\CommentCategoriesRepository;
use App\Repositories\Impl\CommentTopicRepository;
...
class RepositoriesProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(ContractsInterface::class,ContractsRepository::class);
        ...
        $this->app->bind(CommentCategoriesInterface::class,CommentCategoriesRepository::class);
        $this->app->bind(CommentTopicInterface::class,CommentTopicRepository::class);
